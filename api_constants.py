...
LIVE_POSITION = URL_BASE + "TrainPositions/TrainPositions?contentType=json"
STANDARD_ROUTES = URL_BASE + "TrainPositions/StandardRoutes?contentType=json"
TRACK_CIRCUITS = URL_BASE + "TrainPositions/TrackCircuits?contentType=json"
